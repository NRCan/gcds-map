...
function mapmlGlobals () {
    (function (window, document, undefined$1) {
        ...
        M.WGS84 = new ContextMenu.Proj.CRS('EPSG:4326', '+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs ', {
            origin: [-180, 90],
            bounds: ContextMenu.leafletSrcExports.bounds([
                [-180, -90],
                [180, 90]
            ]),
            resolutions: [
            ...
            crs: {
                tcrs: {
                    ...
                    bounds: (zoom) => ContextMenu.leafletSrcExports.bounds([
                ...
                gcrs: {
                    ...
                    get bounds() {
                        return ContextMenu.leafletSrcExports.latLngBounds([
                ...
                map: {
                    ...
                    bounds: (map) => ContextMenu.leafletSrcExports.bounds(ContextMenu.leafletSrcExports.point([0, 0]), map.getSize())
                },
                tile: {
                    horizontal: {
                        name: 'i',
                    ...
                    get bounds() {
                        return ContextMenu.leafletSrcExports.bounds([
        ...
        M.CBMTILE = new ContextMenu.Proj.CRS('EPSG:3978', '+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m +no_defs', {
            ...
            crs: {
                ...
                tilematrix: {
                    ...
                    bounds: (zoom) => ContextMenu.leafletSrcExports.bounds([0, 0], [
        ...
        M.APSTILE = new ContextMenu.Proj.CRS('EPSG:5936', '+proj=stere +lat_0=90 +lat_ts=50 +lon_0=-150 +k=0.994 +x_0=2000000 +y_0=2000000 +datum=WGS84 +units=m +no_defs', {
        ...
        M.OSMTILE = ContextMenu.leafletSrcExports.CRS.EPSG3857;
        ContextMenu.leafletSrcExports.setOptions(M.OSMTILE, {
        ...
        M.geojson2mapml = ContextMenu.Util.geojson2mapml;
        M.mapml2geojson = ContextMenu.Util.mapml2geojson;
        // see https://leafletjs.com/examples/extending/extending-3-controls.html#handlers
        ContextMenu.leafletSrcExports.Map.addInitHook('addHandler', 'query', ContextMenu.QueryHandler);
        ContextMenu.leafletSrcExports.Map.addInitHook('addHandler', 'contextMenu', ContextMenu.ContextMenu);
        ContextMenu.leafletSrcExports.Map.addInitHook('addHandler', 'announceMovement', ContextMenu.AnnounceMovement);
        ContextMenu.leafletSrcExports.Map.addInitHook('addHandler', 'featureIndex', ContextMenu.FeatureIndex);
        // constants
        M.TILE_SIZE = 256;
        ...
        M.defineCustomProjection = function (jsonTemplate) {
            ...
            let tileSize = [256, 512, 1024, 2048, 4096].includes(t.tilesize)
                ? t.tilesize
                : M.TILE_SIZE;
            M[t.projection] = new ContextMenu.Proj.CRS(t.projection, t.proj4string, {
                origin: t.origin,
                resolutions: t.resolutions,
                bounds: ContextMenu.leafletSrcExports.bounds(t.bounds),
                crs: {
                    tcrs: {
                        horizontal: {
                            name: 'x',
                    ...
                    map: {
                        ...
                        bounds: (map) => ContextMenu.leafletSrcExports.bounds([0, 0], map.getSize())
                    },
                    tile: {
                        horizontal: {
                            name: 'i',
