...
var AttributionButton = ContextMenu.leafletSrcExports.Control.Attribution.extend({
  _getLocale: function () {
  ...
  onAdd: function (map) {
    ...
    this._container = ContextMenu.leafletSrcExports.DomUtil.create('details', 'leaflet-control-attribution');
    ContextMenu.leafletSrcExports.DomEvent.disableClickPropagation(this._container);
...
exports.AttributionButton = AttributionButton;
exports.attributionButton = attributionButton;
